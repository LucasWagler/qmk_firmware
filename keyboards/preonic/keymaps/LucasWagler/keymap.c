...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT_ortho_5x12(
        KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_NO,  KC_NO,  KC_F18,  KC_F19,  KC_F20,  KC_F21,  KC_F22,
        KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_NO,  KC_NO,  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,
        GUI_A,   ALT_S,   CTL_D,   SHFT_F,  L2_G,    KC_NO,  KC_NO,  L2_H,    SHFT_J,  CTL_K,   ALT_L,   GUI_SCLN,
        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_NO,  KC_NO,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
        KC_NO,   KC_NO,   KC_NO,   LT(2,KC_ESC), LSFT_T(KC_BSPC), KC_NO, KC_NO, LSFT_T(KC_SPC), LT(1,KC_ENT), KC_NO, DF(15), KC_DEL),
	[1] = LAYOUT_ortho_5x12(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_BTN1, KC_F1, KC_F2, KC_F3, KC_F4, KC_PAUS, KC_NO, KC_NO, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_PSCR, KC_F5, KC_F6, KC_F7, KC_F8, KC_SLCK, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_MUTE, KC_F9, KC_F10, KC_F11, KC_F12, KC_INS, KC_NO, KC_NO, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_MPLY, KC_NO, KC_NO, KC_TRNS, KC_LGUI, LSFT_T(KC_DEL), KC_TRNS, KC_TRNS, LSFT_T(KC_TAB), KC_TRNS, KC_TRNS, KC_NO, RESET),
	[2] = LAYOUT_ortho_5x12(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PLUS, KC_NO, KC_NO, KC_NO, KC_NO, KC_GRV, KC_CIRC, KC_EXLM, KC_LCBR, KC_RCBR, KC_NO, KC_PDOT, KC_EQL, KC_7, KC_8, KC_9, KC_0, LGUI_T(KC_AT), LALT_T(KC_DLR), LCTL_T(KC_AMPR), LSFT_T(KC_LBRC), LT(2,KC_RBRC), KC_NO, KC_NO, LT(2,KC_MINS), LSFT_T(KC_4), LCTL_T(KC_5), LALT_T(KC_6), LGUI_T(KC_QUOT), KC_BSLS, KC_PERC, KC_HASH, KC_LPRN, KC_RPRN, KC_NO, KC_NO, KC_ASTR, KC_1, KC_2, KC_3, KC_SLSH, KC_NO, KC_NO, KC_TRNS, KC_TRNS, LSFT_T(KC_DEL), KC_TRNS, KC_TRNS, LSFT_T(KC_TAB), KC_LGUI, KC_TRNS, KC_NO, RESET),
