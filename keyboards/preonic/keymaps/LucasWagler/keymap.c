...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [0] = LAYOUT_ortho_5x12(KC_BTN2, KC_WH_L, KC_WH_U, KC_WH_D, KC_WH_R, KC_BTN3, KC_BTN3, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_BTN1, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_BTN4, KC_BTN5, KC_Y, KC_U, KC_I, KC_O, KC_P, GUI_A, ALT_S, CTL_D, SHFT_F, L2_G, RGB_HUD, RGB_HUI, L2_H, SHFT_J, CTL_K, ALT_L, GUI_SCLN, KC_Z, KC_X, KC_C, KC_V, KC_B, RGB_SAD, RGB_SAI, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RGB_TOG, RGB_MOD, KC_BRID, L2_ESC, SHFT_BSP, RGB_VAD, RGB_VAI, SHFT_SPC, L1_ENT, KC_BRIU, DF(15), KC_DEL),
        [1] = LAYOUT_ortho_5x12(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_PAUS, KC_TRNS, KC_TRNS, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT, KC_MPLY, KC_F5, KC_F6, KC_F7, KC_F8, KC_SLCK, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_MUTE, KC_F9, KC_F10, KC_F11, KC_F12, KC_INS, KC_TRNS, KC_TRNS, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_PSCR, KC_TRNS, KC_TRNS, KC_TRNS, LT(2,KC_ESC), LSFT_T(KC_DEL), KC_TRNS, KC_TRNS, LSFT_T(KC_TAB), KC_TRNS, KC_TRNS, KC_TRNS, RESET),
        [2] = LAYOUT_ortho_5x12(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_1, KC_2, KC_3, KC_4, KC_5, KC_TRNS, KC_TRNS, KC_6, KC_7, KC_8, KC_9, KC_0, LGUI_T(KC_GRV), LALT_T(KC_MINS), LCTL_T(KC_LBRC), LSFT_T(KC_RBRC), KC_PPLS, KC_TRNS, KC_TRNS, KC_PEQL, RSFT_T(KC_4), RCTL_T(KC_5), LALT_T(KC_6), RGUI_T(KC_QUOT), KC_BSLS, KC_SLSH, KC_LPRN, KC_RPRN, KC_PAST, KC_TRNS, KC_TRNS, KC_DOT, KC_1, KC_2, KC_3, KC_SLSH, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LSFT_T(KC_DEL), KC_TRNS, KC_TRNS, LSFT_T(KC_TAB), LT(1,KC_ENT), KC_TRNS, KC_TRNS, RESET),
